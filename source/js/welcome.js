...
$.ajax({
  ...
  data: {
    key: 'FCDBZ-5Y7Y7-QQRXV-H7LRC-VGDRO-ZBBTT',
    output: 'jsonp',
  },
  dataType: 'jsonp',
...
function showWelcome() {
  ...
  let dist = getDistance(121.82349, 39.088186, ipLocation.result.location.lng, ipLocation.result.location.lat); //这里记得换成自己的经纬度
